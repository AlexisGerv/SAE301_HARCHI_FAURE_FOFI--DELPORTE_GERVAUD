...
<div style="max-width: 400px; margin: 50px auto; text-align: center;">
    ...
    <form action="controleurs/connexion.php" method="post">
        <input type="email" name="email" placeholder="Email IUT" required style="width:100%; margin-bottom:10px; padding:10px;">
        <input type="password" name="password" placeholder="Mot de passe" required style="width:100%; margin-bottom:10px; padding:10px;">
